...
add_action( 'tgmpa_register', 'nikah_register_required_plugins' );
 ...
 */
function nikah_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'     				=> esc_html__( 'Nikah Extra', 'nikah' ), // The plugin name
			'slug'     				=> 'nikah-extra', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/plugins/nikah-extra.zip', // The plugin source
		...
		array(
			'name'     				=> esc_html__( 'Contact Form 7', 'nikah' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'ACF Pro', 'nikah' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Redux Framework', 'nikah' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Elementor', 'nikah' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Revolution Slider', 'nikah' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'One Click Demo Import', 'nikah' ), // The plugin name
		...
		array(
            'name'                     => esc_html__( 'Preloader Awesome', 'nikah' ), // The plugin name
